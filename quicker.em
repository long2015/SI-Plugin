macro AutoExpand()
{
    ...
    if( Linelen > sel.ichFirst+1 )
    {
        str1 = szLine[sel.ichFirst]
        str2 = szLine[sel.ichFirst+1]
    }
    ...
    else if ( Linelen > sel.ichFirst+1 && str1 == ")" && str2 == ";")
    {
...
macro FuncHeadCommentCN(hbuf, ln, szFunc, szMyName,newFunc)
{
    ...
    InsBufLine(hbuf, ln+4, "\t/// \\param[out] @szRet@")
